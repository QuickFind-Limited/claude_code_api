...
# Ensure required environment variables are present early during startup
REQUIRED_ENV_VARS = [
    "ANTHROPIC_API_KEY",
...
if missing_env:
    ...
    raise RuntimeError(
        ...
        f"{missing_list}. Copy .env.example to .env and provide valid secrets before starting the server."
    )
